...
<head>
    <meta charset="gb2312">
    <title><?php echo BIND_APP=='mip'?toutf8('系统发生错误'):'系统发生错误'?></title>
...
<body>
    ...
    <div class="message">
            ...
            <div class="info">
                ...
                <div><h1><?php echo nl2br((BIND_APP=='mip'?toutf8($message):$message)); ?></h1></div>
            </div>
        
    </div>
	<?php if(!empty($source)){?>
        <div class="source-code">
            <pre class="prettyprint lang-php"><ol start="<?php echo $source['first']; ?>"><?php foreach ((array) $source['source'] as $key => $value) { ?><li class="line-<?php echo $key + $source['first']; ?>"><code><?php echo ($value); ?></code></li><?php } ?></ol></pre>
        </div>
	<?php }?>
        <div class="trace">
            <h2>Call Stack</h2>
    ...
    <div class="exception">
            ...
            <div class="info">
            	<h1><?php echo BIND_APP=='mip'?toutf8($message):$message; ?></h1></div>
